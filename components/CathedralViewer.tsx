...
export default function CathedralViewer() {
  ...
  // Build-theater: a human landing (no ?cam=) watches the cathedral assemble from t=0;
  // automated capture (?cam=) renders the COMPLETE model so the verifier grades it.
  const isCam = () =>
